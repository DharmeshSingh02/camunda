...
public class ElasticsearchProperties {
  ...
  @NestedConfigurationProperty private List<InterceptorPluginProperties> interceptorPlugins;
  ...
  public List<InterceptorPluginProperties> getInterceptorPlugins() {
    return interceptorPlugins;
  }

  public void setInterceptorPlugins(final List<InterceptorPluginProperties> interceptorPlugins) {
